...
| `servo_pwm_max`               | no                                   | pwm value corresponding to the motor at full speed forwards        | [Servo PWM (`BB_ACTION_SERVO`)](action_event_list.md#servo-pwm-bb_action_servo)                    |                                                                                   |
| `servo_pwm_min`               | no                                   | pwm value corresponding to the motor at full speed backwards       | [Servo PWM (`BB_ACTION_SERVO`)](action_event_list.md#servo-pwm-bb_action_servo)                    |                                                                                   |
| `servo_pwm_mid`               | no                                   | pwm value corresponding to turning the motor off                   | [Servo PWM (`BB_ACTION_SERVO`)](action_event_list.md#servo-pwm-bb_action_servo)                    |                                                                                   |
| `servo_pwm_freq`              | no                                   | frequency of the pwm output                                        | [Servo PWM (`BB_ACTION_SERVO`)](action_event_list.md#servo-pwm-bb_action_servo)                    |                                                                                   |
